...
public class UpdateFood {
   ...
   JPanel backgroundPanel = new JPanel() {
       ...
       protected void paintComponent(Graphics g) {
           ...
           Image backgroundImage = new ImageIcon("C:/Users/CHARAN/Downloads/update2bg.jpg").getImage(); // Replace "path/to/your/image.jpg" with the actual path to your image
   ...
   public void showButtonDemo(){
      ...
      headerLabel.setText("CSV Restaurant      ");
 headerLabel.setFont(new Font(null, Font.BOLD, 27));

        name = new JLabel("Enter Name");
        JTextField tf2=new JTextField();
        tf2.setSize(2000,600);
      ...
      okButton.addActionListener(new ActionListener() {
         public void actionPerformed(ActionEvent e) {
            ...
            try{
                pst = con.mkDataBase().prepareStatement("UPDATE food SET f_quantity= ?, f_prize=? where f_name = ?");
